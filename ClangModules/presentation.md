...
.right-column[
## I am still learning so there would be questions that I have no answer to
![Confused](https://media.giphy.com/media/CPskAi4C6WLHa/giphy.gif)
]
...
<img src="https://www.gospelcrusader.com/wp-content/uploads/2018/03/alternative.jpg" width="400px"/>
...
.right-column[
* compiler spawns a second instance of itself
...
.right-column[
* Parses headers in that modules.
]

--

.right-column[
* Resulting Abstract Syntax Tree (AST) is then persisted into the binary representation of the module
* Load in translation unit
]
...
## Ok, clang will translate automatically
...
![Q&A](https://media.giphy.com/media/l0IyjeA5mmMZjhyPm/giphy.gif)
